...
#include "depth_testing_example_app.hpp"

std::vector<GLfloat> DepthTestingApp::cubeVertices = {
...
std::vector<GLfloat> DepthTestingApp::planeVertices = {
...
DepthTestingApp::DepthTestingApp(mylib::Window&& window) : 
	mylib::App(std::move(window))
{}

void DepthTestingApp::startup()
{
	shader = mylib::Shader({
		std::make_pair(
...
void DepthTestingApp::update(double time)
{
